...
export const mockTodos: Todo[] = [
  { id: '1', title: 'Finalize Q3 report', status: 'in-progress', priority: 'high', dueDate: new Date(new Date().setDate(new Date().getDate() + 2)).toISOString() },
  { id: '2', title: 'Schedule dentist appointment', status: 'todo', priority: 'medium', dueDate: new Date(new Date().setDate(new Date().getDate() + 7)).toISOString() },
  { id: '3', title: 'Buy birthday gift for Sarah', status: 'todo', priority: 'high', dueDate: new Date(new Date().setDate(new Date().getDate() - 1)).toISOString() },
  { id: '4', title: 'Complete Next.js tutorial', status: 'done', priority: 'low', dueDate: null },
  { id: '5', title: 'Draft project proposal', status: 'in-progress', priority: 'high', dueDate: new Date(new Date().setDate(new Date().getDate() + 3)).toISOString() },
  { id: '6', title: 'Weekly grocery shopping', status: 'todo', priority: 'medium', dueDate: new Date(new Date().setDate(new Date().getDate() + 4)).toISOString() },
  { id: '7', title: 'Pay credit card bill', status: 'done', priority: 'high', dueDate: null },
  { id: '8', title: 'Call Mom', status: 'todo', priority: 'low', dueDate: null },
];
